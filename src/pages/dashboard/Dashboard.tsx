  ...
  return (
    <div className="dashboard">
      <div className="dashboard__content">
        <h1 className="dashboard__title">Breaking news!</h1>
        <article className="dashboard__description-wrapper">
          <section className="dashboard__description">
            <h2 className="description__title">Master CSS through gameplay and delve into the world of mythical creatures!</h2>
        ...
        <h2 className="dashboard__subtitle">Choose a level and start playing with CSS</h2>
