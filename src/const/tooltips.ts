export const tooltips: { [key: string]: string } = {
    'font-family': '<p>Specifies the font and its fallbacks, separated by comma. \n <code>[specific-font-family], [generic-font-family]</code> | <code>initial</code> | <code>inherit</code> \n font-family: "Crimson Text", serif;</p>',
    'font-size': '<p>Defines the size of your text. \n <code>[number-of-units][unit]</code> \n font-size: 3.5em;',
    'font-style': '<p>Names the style to be applied to the text \n <code>normal</code> | <code>italic</code> | <code>oblique</code> | <code>initial</code> | <code>inherit</code> \n font-style: normal;',
    'font-weight': '<p>Sets how thick or thin the characters should be \n <code>normal</code> | <code>bold</code> | <code>bolder</code> | <code>lighter</code> | <code>[number]</code> | <code>initial</code> | <code>inherit</code> \n font-weight: normal;',
    'color': ' <p>Names the color of the text \n <code>[color]</code> | <code>initial</code> | <code>inherit</code>; \n color: red;</p>',
